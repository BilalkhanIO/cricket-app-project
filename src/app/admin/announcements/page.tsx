  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/announcements/new" className="bg-green-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-green-700">
          + Post Announcement
        </Link>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-3 text-xs text-gray-400">
                    ...
                    <span className={`px-2 py-0.5 rounded ${ann.isPublic ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-600"}`}>
        ...
        {announcements.length === 0 && (
          <Card>
            <CardBody className="text-center py-10">
              ...
              <Link href="/admin/announcements/new" className="text-green-600 hover:underline text-sm">Post your first announcement →</Link>
            </CardBody>
          </Card>
        )}
      </div>
