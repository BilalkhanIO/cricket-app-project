  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/venues/new" className="bg-[color:var(--primary)] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#185a41]">
          + Add Venue
        </Link>
      </div>
          ...
          <Card key={venue.id}>
            <div className="p-5">
              <div className="flex items-start gap-3 mb-3">
                <div className="w-10 h-10 bg-[color:var(--card-muted)] rounded-xl flex items-center justify-center text-xl">🏟️</div>
                <div>
      ...
      {venues.length === 0 && (
        <Card>
          <div className="text-center py-12">
            ...
            <Link href="/admin/venues/new" className="text-[color:var(--primary)] hover:underline text-sm">Add your first venue →</Link>
          </div>
        </Card>
      )}
    </div>
